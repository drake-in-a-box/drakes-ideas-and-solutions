window.ideasCatalog = [
  ...
  {
    slug: 'sports-card-valuation-dashboard',
  ...
  {
    slug: 'phone-voice-controller',
    title: 'Phone Voice Controller',
    category: 'Smart Surfaces',
    stage: 'Ready to prototype',
    readiness: 'Hybrid app path',
    summary: 'Push-to-talk control on a phone with playback on both phone and TV machine.',
    description:
      'A local-network control surface that avoids creepy always-listening behavior and feels intentional instead of gimmicky.',
    value:
      'Lets you control the TV and local experiences in a way that feels useful, not like another AI toy nobody sticks with.',
    nextAction:
      'Prototype a phone-first interface with explicit push-to-talk and paired playback routing.',
